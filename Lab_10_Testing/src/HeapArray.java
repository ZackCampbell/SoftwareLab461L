 ...
 * that array[n] <= array[2*n + 1] and array[n] <= array[2*n + 2] for all elements in
 * the array, when the root is at n = 0.
 *
 * @param <E>
...
public class HeapArray<E extends Comparable<E>> implements Iterable<E> {
     ...
     *
     * @param index the index where the target should initially be placed.
